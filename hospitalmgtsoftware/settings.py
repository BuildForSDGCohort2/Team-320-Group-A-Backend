...
# SECRET_KEY = "&f_22on8!f=!zh@aae!hi26v=rorn$4inmd^-%p(7=ax)&5-^z"
...
ROOT_URLCONF = 'hospitalmgtsoftware.urls'
...
WSGI_APPLICATION = 'hospitalmgtsoftware.wsgi.application'
...
#Console EmailBackend for Development
